...
/*     .bgimg-1 { */
/*         background-image: url('${pageContext.request.contextPath}/resources/night.jpg'); */
/*         min-height: 100%; */
/*     } */
...
/*     /* Third image (Contact) */ */
/*     .bgimg-3 { */
/*         background-image: url("${pageContext.request.contextPath}/resources/java.jpg"); */
/*         min-height: 400px; */
/*     } */
...
<!--         <span class="w3-center w3-padding-xlarge w3-xlarge w3-wide w3-animate-opacity"><img  -->
<%--         	src="${pageContext.request.contextPath}/resources/under-construction.png" sizes="50%"></span> --%>

<%--         <span class="w3-center w3-padding-xlarge w3-black w3-xlarge w3-wide w3-animate-opacity"><img --%>
<%--                 src="${pageContext.request.contextPath}/resources/test_site_2.jpg"></span> --%>
<!--     </div> -->
<!-- </div> -->
...
<!--             <p><b>Maksim Chvertock</b></p><br> -->
<%--             <img src="${pageContext.request.contextPath}/resources/maks.jpeg" class="w3-circle" alt="Photo of Me"> --%>
<!--         </div> -->
...
<!--     <p>Powered by <a href="http://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" -->
