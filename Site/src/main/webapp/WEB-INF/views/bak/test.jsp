...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/w3/w3-theme-black.css">
<link rel="stylesheet"
...
<div class="w3-top">
    <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
        <li class="w3-hide-medium w3-hide-large w3-opennav w3-right">
            <a class="w3-hover-white w3-large w3-theme-d2" href="javascript:void(0);" onclick="openNav()"><i
                    class="fa fa-bars"></i></a>
        </li>
        <li><a href="#" class="w3-teal"><i class="fa fa-home w3-margin-right"></i>Logo</a></li>
        <li class="w3-hide-small"><a href="#" class="w3-hover-white">Link 1</a></li>
        <li class="w3-hide-small"><a href="#" class="w3-hover-white">Link 2</a></li>
        ...
        <li class="w3-hide-small w3-right"><a href="#" class="w3-hover-teal" title="Search"><i class="fa fa-search"></i></a>
        </li>
    </ul>
</div>
...
<div class="w3-display-container w3-animate-opacity">
    <img class="testimg" src="${pageContext.request.contextPath}/resources/java.png" alt="boat"
         style="width:100%;min-height:350px;max-height:600px;">
    <div class="w3-container w3-display-bottomleft w3-margin-bottom">
        <button onclick="document.getElementById('id01').style.display='block'"
                class="w3-btn w3-xlarge w3-theme w3-hover-teal" title="Go To W3.CSS">LEARN W3.CSS
        </button>
    </div>
</div>
...
<%--<img src="${pageContext.request.contextPath}/resources/avatar.jpg" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">--%>
<%--<h3>Johnny Walker</h3>--%>
<%--<p>Web Designer</p>--%>
<%--</div>--%>
...
<div class="w3-container w3-padding-64 w3-theme-l5">
    <div class="w3-row">
        <div class="w3-col m5">
            ...
            <p><i class="fa fa-map-marker w3-text-teal w3-xlarge"></i><spring:message code="contacts.address"/></p>
            <p><i class="fa fa-phone w3-text-teal w3-xlarge"></i><spring:message code="contacts.phone.mts"/></p>
            <p><i class="fa fa-envelope-o w3-text-teal w3-xlarge"></i><spring:message code="contacts.gmail"/></p>
        </div>
        <div class="w3-col m7">
            <form class="w3-container w3-card-4 w3-padding-16 w3-white">
                ...
                <button type="button" class="w3-btn w3-right w3-theme"><spring:message
                        code="form.button.send"/></button>
            </form>
        </div>
    </div>
</div>
...
<script>
    var myCenter = new google.maps.LatLng(53.9045, 27.5615);
...
<footer class="w3-container w3-padding-32 w3-theme-d1 w3-center">
    ...
    <a class="w3-btn-floating w3-teal w3-hide-small" href="javascript:void(0)" title="Linkedin"><i
