...
<form:form
	...
	method="post"
	action="${pageContext.request.contextPath}/action/addNewMessage"
...
<!-- 	</div> -->
	...
	<div class="w3-group">
		<label class="w3-label"><spring:message code="new_message.text" /></label>
<!-- 		<input class="w3-input" type="text" name="text" required="required"> -->
	...
	<input class="w3-btn w3-right w3-theme" type="submit" value="<spring:message code="new_message.submit"/>"/>
</form:form>